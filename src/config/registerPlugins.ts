import { CorePlugin, LoopProtectorPlugin } from "@volley/flowscript";
import { EngineHandler } from "@volley/gev-engine-handler";
import { AmplitudePlugin } from "@volley/gev-plugin-amplitude";
...
export default async function registerPlugins(
  ...
  engineHandler.registerPlugin(new AmplitudePlugin<User, Intent, Platforms>());
